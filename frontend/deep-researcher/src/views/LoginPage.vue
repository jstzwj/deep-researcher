<template>
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900">
      <div class="max-w-md w-full space-y-8">
        ...
        <div
          v-if="errorMessage"
          class="bg-red-100 dark:bg-red-900 dark:bg-opacity-20 border border-red-400 dark:border-red-700 text-red-700 dark:text-red-200 px-4 py-3 rounded relative"
          role="alert"
        >
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleLogin">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              />
              <label for="remember-me" class="ml-2 block text-sm text-secondary-900 dark:text-secondary-300">
                {{ $t('login.rememberMe') }}
              </label>
            </div>
